...
public class generate_legend_01
{
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Dressing Room", 
				 "amenity", "dressing_room", 
				 "name", "Name" );

	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Reception Desk", 
				 "amenity", "reception_desk", 
				 "name", "Name" );

	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Payment Terminal", 
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Railway Help Point", 
				 "amenity", "help_point", 
				 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Throw Bag", 
				 "emergency", "throw_bag", 
				 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Pier", 
				 "man_made", "pier", 
				 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Binoculars", 
				 "amenity", "binoculars_free", 
				 "name", "Name" );

	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "(pay)", 
				 "amenity", "binoculars_pay", 
				 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Balancebeam", 
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Archery",
			 "leisure", "pitch", 
			 "sport", "archery", 
			 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Bank with ATM", 
				 "amenity", "bank", 
				 "atm", "yes", 
				 "name", "Name" );
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Enclosure", 
				 "historic", "archaeological_site", 
	...
	currentCol += 1;
	writeLabelledNodeRowCol( myOutputOsmStream, startNode, currentRow, currentCol, "Zebra", 
				 "highway", "crossing", 
				 "crossing", "zebra", 
				 "name", "Name" );
